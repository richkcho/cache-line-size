...
/// and if there are multiple caches available, it returns the size of the **smallest** cache.
#[inline]
pub fn get_l2_cache_line_size() -> Option<usize> {
    get_cache_line_size(CacheLevel::L2, CacheType::Unified)
}
...
/// and if there are multiple caches available, it returns the size of the **smallest** cache.
#[inline]
pub fn get_l3_cache_line_size() -> Option<usize> {
    get_cache_line_size(CacheLevel::L3, CacheType::Unified)
}
